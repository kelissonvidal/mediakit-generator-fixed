...
export default function Home() {
  const [data, setData] = useState<MediaKitData>({
    ...
    companies: [
      { name: 'Festival Mineiridades', link: 'https://instagram.com/p/exemplo1' },
      { name: 'Lumak Balanças', link: 'https://instagram.com/p/exemplo2' },
      { name: 'Zé Delivery', link: 'https://instagram.com/p/exemplo3' },
    ],
